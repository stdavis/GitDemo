define('IdentifyTiles', [
    ...
    return declare(null, {
        ...
        onMapClick: function(evt) {
            ...
            this.mapClickPoint = evt.mapPoint;
        ...
        onQueryTaskComplete: function(fSet) {
            ...
            if (fSet.features.length > 0) {
                ...
                this.setDownloadLink(url, g.attributes[this.fields.TILE]);
            } else {
        ...
        setDownloadLink: function(url, tileName) {
            // summary:
            //      Sets the download link innerHTML and href
            // url: String
            console.log('IdentifyTiles:setDownloadLink', arguments);

            this.map.infoWindow.setTitle(tileName);
            this.map.infoWindow.setContent("<a href='" + url + "'>download</a>");
            this.map.infoWindow.show(this.mapClickPoint);
        }
    });
});
